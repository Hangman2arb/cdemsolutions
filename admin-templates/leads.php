            ...
            <nav class="admin-pagination">
                <?php if ($cur > 1): ?>
                <a href="/admin/leads/?page=<?= $cur - 1 ?>&status=<?= urlencode($status) ?>&search=<?= urlencode($search) ?>" class="admin-pagination__link admin-pagination__arrow">&lsaquo;</a>
                <?php endif; ?>
                ...
                <?php endforeach; ?>
                <?php if ($cur < $last): ?>
                <a href="/admin/leads/?page=<?= $cur + 1 ?>&status=<?= urlencode($status) ?>&search=<?= urlencode($search) ?>" class="admin-pagination__link admin-pagination__arrow">&rsaquo;</a>
                <?php endif; ?>
            </nav>
            <?php endif; ?>
            <?php endif; ?>
