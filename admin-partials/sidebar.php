    <aside class="sidebar" id="sidebar">
        <div class="sidebar__brand">
            <a href="/admin/dashboard/">
                <img src="/img/logo.png" alt="CDEM" width="32" height="32">
                <span>CDEM<strong>Admin</strong></span>
            </a>
        </div>
        <nav class="sidebar__nav">
            <a href="/admin/dashboard/" class="sidebar__link <?= ($admin_page ?? '') === 'dashboard' ? 'active' : '' ?>">
            ...
            <a href="/admin/leads/" class="sidebar__link <?= ($admin_page ?? '') === 'leads' || ($admin_page ?? '') === 'lead-detail' ? 'active' : '' ?>">
            ...
            <a href="/admin/blog/" class="sidebar__link <?= in_array($admin_page ?? '', ['blog-list', 'blog-edit']) ? 'active' : '' ?>">
            ...
            <a href="/admin/blog/tags/" class="sidebar__link <?= ($admin_page ?? '') === 'blog-tags' ? 'active' : '' ?>">
            ...
            <a href="/admin/seo/" class="sidebar__link <?= ($admin_page ?? '') === 'seo' ? 'active' : '' ?>">
            ...
            <a href="/admin/settings/" class="sidebar__link <?= ($admin_page ?? '') === 'settings' ? 'active' : '' ?>">
