...
return [
    ...
    'meta' => [
        'title' => 'CDEM Solutions — Empowering Your Digital Future',
        'description' => 'We partner with forward-thinking businesses to deliver AI-driven solutions, custom software, and digital strategies that drive real results.',
        'keywords' => 'AI solutions, software development, digital consulting, cloud services, cybersecurity, data analytics, CDEM Solutions',
    ],
    ...
    'hero' => [
        ...
        'subtitle' => 'We partner with forward-thinking businesses to deliver AI-driven solutions, custom software, and digital strategies that drive real results.',
    ...
    'why_us' => [
        ...
        'title_highlight' => 'Built Better',
        'subtitle' => 'We don\'t just build software — we build partnerships that last.',
        'items' => [
            [
                'icon' => 'lightbulb',
                'title' => 'Innovation First',
                'description' => 'We stay at the forefront of technology, integrating AI and emerging tools into every solution we deliver.',
            ],
            [
                'icon' => 'sync',
                'title' => 'Agile & Transparent',
                'description' => 'Clear communication, iterative development, and no surprises. You\'re always in the loop.',
            ],
            [
                'icon' => 'rocket',
                'title' => 'End-to-End Service',
                'description' => 'From concept to deployment and beyond, we handle every stage of your project lifecycle.',
            ],
            [
                'icon' => 'target',
                'title' => 'Results-Driven',
                'description' => 'We measure success by your success. Every solution is designed to deliver measurable impact.',
            ],
        ],
    ],
    ...
    'cta' => [
        ...
        'subtitle' => 'Let\'s discuss how we can help you leverage technology to achieve your goals.',
        'button' => 'Get in Touch',
    ],
    ...
    'footer' => [
        'description' => 'Technology solutions that empower businesses to thrive in the digital age.',
        'quick_links' => 'Quick Links',
        'services_title' => 'Services',
        'connect' => 'Connect',
        'copyright' => '© 2026 CDEM Solutions. All rights reserved.',
